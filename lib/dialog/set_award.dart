...
class SetAwards extends StatefulWidget {
  final bool isEdit;
  const SetAwards(this.isEdit, {Key? key}) : super(key: key);

  @override
  State<SetAwards> createState() => _SetAwardsState();
}

class _SetAwardsState extends State<SetAwards> {
