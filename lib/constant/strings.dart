...
const MERCHANTTYPE = ['Ambulance Air/Land/Sea', 'Commentary/Burial Centers', 'Hospital/Clinic', 'HMO/Insurance', 'Pharmacy Store', 'Laboratory/Diagnosis', 'Other Health Provider'];

const CUSTOMERTYPE = ['Walk-In Customer', 'Online Customer', 'Caash Customer', 'Credit Customer', 'Other Customer'];

const VENDORTYPE = ['Manufacturer', 'Distributor', 'Importer', 'Other Health Provider'];
...
List ONBOARDING = [
  {
    'image': 'assets/auth/instant_prescription.png',
    'title': 'Instant Prescription And Reminder For Your Patient',
    'description': 'Get access to Millions of Patients from different race, ethnicity and diversity across Africa and Globally, you can easily chat, video or voice call and book online appointment with patients.'
  },
  {
    'image': 'assets/auth/book_appointment.png',
    'title': 'Book Appointments with Doctors Right from your Phone and System!',
    'description': 'Get Access to Millions of Patients and Tools to help your Business without Borders, Boundaries and limitations.'
  },
  {
    'image': 'assets/auth/databases.png',
    'title': 'Browse the Largest Database',
    'description': 'Join the Largest Database of Doctors, Nurses, Pharmacist, Pharmacy Stores, Hospitals and Clinics, Health Insurance and Other Health Services Providers in Africa and Globally with Just a click Away.'
  },
  {'image': 'assets/auth/e_store.png', 'title': 'A Smarter Ways to Save More on the E-Store!', 'description': 'You Can Order You’re Medications, Health Equipment and Accessories Delivered to Your Home or Office at your Convenience.'},
  {
...
List removeBottom = [3, 11, -7, 14, 15, 9, 10, 17, 12, 13, 16, 19, 21, 20, 22, 23, 8, 6, -5, 18, -7, 2, 7, 5];
List removeBottom1 = [3, 11, -7, 14, 15, 9, 10, 17, 12, 13, 16, 19, 21, 20, 22, 23, 8, 6, -5, -7, 18, 2, 7, 5];
...
List<NavDrawerItem> getNavdraweritem_(BuildContext context) {
  return [
    ...
    NavDrawerItem(title: 'E-stores', icon: FontAwesome5.store, children: [], isOpen: false, index: 4),
    NavDrawerItem(title: 'My Store', icon: FontAwesome.heart, children: [], isOpen: false, index: 2),
    NavDrawerItem(title: 'My Calender', icon: Icons.folder, children: [], isOpen: false, index: 3),
    ...
    NavDrawerItem(
        ...
        isOpen: false,
        index: -0),
    NavDrawerItem(title: 'Doctor Booking', icon: FontAwesome5.user_nurse, children: [], isOpen: false, index: 23),
    NavDrawerItem(
        title: 'Product Mgt.',
    ...
    NavDrawerItem(
        ...
        isOpen: false,
        index: -0),
    NavDrawerItem(title: 'My Profile', icon: FontAwesome5.user, children: [], isOpen: false, index: 6),
    NavDrawerItem(
        title: 'Settings',
        icon: Icons.settings,
        children: [
...
List homeItem1 = [
  {'icon': 'assets/others/customers.png', 'title': 'My Customers', 'desc': 'Manage All your Customers records and billing with just a click.'},
  {'icon': 'assets/others/appointments.png', 'title': 'Appointments', 'desc': 'See all incoming and past appointments, you can also reschedule and accept or reject appoinments'},
  {'icon': 'assets/others/order_medicine.png', 'title': 'Order medicines', 'desc': 'Get a low rate of interest for all medications from local and international suppliers'}
];

List homeItem2 = [
  {'icon': 'assets/others/brands.png', 'title': 'Health brands', 'desc': 'Sale and Order Health Suppliers from Top Brands around the world with much hassles.'},
  {'icon': 'assets/others/whatsapp.png', 'title': 'Book On Whatsapp', 'desc': 'Speak to our Support Agents to Book and order products and services from whatsapp.'},
  {'icon': 'assets/others/create_invoice.png', 'title': 'Create Invoices', 'desc': 'You can manage all your customers and suppliers invoices including in app billings .'},
  {'icon': 'assets/others/qr.png', 'title': 'QR Scanner', 'desc': 'You can scan QR code to accept payments from your customers aywhere and anytime.'},
  {'icon': 'assets/others/manage_stock.png', 'title': 'Manage Stocks', 'desc': 'You can create, edit and manage your stocks in multiple stores and see your stock movements'}
];
